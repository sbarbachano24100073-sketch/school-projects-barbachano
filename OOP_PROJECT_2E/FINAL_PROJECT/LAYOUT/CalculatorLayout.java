...
class Calculator extends JFrame implements ActionListener {
    ...
    private Color bgColor = new Color(245, 245, 245);         // Light background
    private Color btnColor = new Color(230, 230, 250);        // Lavender for numbers
    private Color opColor = new Color(40, 40, 40);            // Charcoal black for operators
    private Color equalColor = new Color(100, 149, 237);      // Cornflower blue
    ...
    public Calculator() {
        ...
        for (JButton btn : functionButtons) {
            ...
            btn.setForeground(Color.WHITE); // Ensures readability on dark background
        ...
        clrButton.setBackground(new Color(255, 182, 193)); // Light pink
        delButton.setBackground(new Color(255, 218, 185)); // Peach puff
